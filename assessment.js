...
var secondJedi = jedi.splice(jedi.indexOf('Obi-Wan'),1).toString();
...
function removeThings(arr, thing) {
	...
	return arr; //THIS DOES REMOVE ALL INSTANCES OF ITEM BUT IT SAYING IT DOESN"T
}
...
//it looks to see if the actor's name is Andrew Garfield and changes the actor object to 
//have a property called spiderRating with a value of 10.  If their name is Tobey Maguire set 
//spiderRating to 0.  otherwise set spiderRating to 'not a spiderman'.
